...
// Memória temporária para evitar duplicidade
  ...
  try {
    for (const ativo of ATIVOS) {
      ...
      try {
        ...
        const resApi = await fetch(urlM15, { headers: { 'User-Agent': 'Mozilla/5.0' }, signal: AbortSignal.timeout(8000) });
        ...
        // LÓGICA FRACTAL i-2 (ALINHADA RT_ROBO_V.01)
