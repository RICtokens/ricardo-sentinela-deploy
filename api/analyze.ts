  ...
  try {
    for (const ativo of ATIVOS) {
      ...
      for (let j = 0; j < 3; j++) {
        ...
        // Lógica Fractal RT_ROBO_V.02 (Vela i-2 comparada a i-4, i-3, i-1 e i) 
    ...
    const statusEur = getStatus("EURUSD") ? "ABERTO" : "FECHADO"; [cite: 1]
